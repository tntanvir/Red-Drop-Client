  ...
  return (
    <div className=" text-black flex-row md:flex justify-around items-center md:px-16 px-2 bg-yellow-700 relative md:pb-14">
      ...
      <div className="md:w-1/2">
        ...
        <p className='text-justify font-light md:mt-4'>At Red Drop, we believe that every drop counts, and every act of kindness can make a significant difference. Our mission is simple: to provide a lifeline of hope through blood donation.</p>
        <div className='flex gap-5 justify-center mt-2 md:justify-start md:mt-4 md:absolute'>
